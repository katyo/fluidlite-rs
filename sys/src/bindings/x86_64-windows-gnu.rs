...
pub const FLUID_PRESET_SELECTED: ::std::os::raw::c_uint = 0;
pub const FLUID_PRESET_UNSELECTED: ::std::os::raw::c_uint = 1;
pub const FLUID_SAMPLE_DONE: ::std::os::raw::c_uint = 2;
